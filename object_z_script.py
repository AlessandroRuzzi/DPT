...
def calc_lenght(img_tensor, mask_tensor_p, mask_tensor_o, x_pers_pos, x_obj_pos, y_pers_pos, y_obj_pos, pred_obj_z, gt_lenght):
...
for kid in kid_list:
 ...
 # print(img_tensor.shape)
  ...
  pred_obj_z, lenght = calc_lenght(img_tensor, mask_tensor_p, mask_tensor_o, x_pers_pos, x_obj_pos, y_pers_pos, y_obj_pos, pred_obj_z, obj_dim )
